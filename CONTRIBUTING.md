# Contributing to bootstrap-canjs

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/icanjs/bootstrap-canjs) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork bootstrap-canjs, you can start by going to its [fork page](https://github.com/icanjs/bootstrap-canjs/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/bootstrap-canjs
```
